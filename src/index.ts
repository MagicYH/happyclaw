...
// ── v3 §5.2 路由阶段 0+4：按连接类型选择 folder 来源 ─────────────────────────
// 纯函数实现已迁移到 src/route-helpers.ts，此处 re-export 保持向后兼容。
export type { RouteTarget, RouteDeps } from './route-helpers.js';
export { resolveRouteTarget } from './route-helpers.js';
