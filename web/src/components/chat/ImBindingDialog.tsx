  ...
  return (
    <>
          ...
          <div className="space-y-2 max-h-72 overflow-y-auto">
            ...
            {!loading && imGroups.length === 0 && (
              <div className="text-center py-8 text-muted-foreground text-sm">
                暂无群聊可绑定。请先在飞书/Telegram/Discord 群中向 Bot
                发送消息，群聊会自动出现在此列表中。
                <br />
      ...
      <ConfirmDialog
        ...
        message={
          rebindTarget
            ? `该群组当前已绑定到${describeBindTarget(rebindTarget.group)}，确认换绑到当前${isMainMode ? '主对话' : 'Agent'}吗？`
            : ''
        }
        confirmText="换绑"
      />
