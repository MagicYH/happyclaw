...
const SCHEME_OPTIONS: {
...
}[] = [
  {
    value: 'default',
    label: '经典绿',
    preview: { bg: '#ffffff', accent: '#0d9488', text: '#0f172a' },
  },
  {
    value: 'orange',
    label: '暖橙',
  ...
  },
  {
    value: 'neutral',
    label: '素白',
    preview: { bg: '#ffffff', accent: '#52525b', text: '#18181b' },
  },
];
    ...
    <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            {SCHEME_OPTIONS.map((opt) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-medium ${colorScheme === opt.value ? 'text-primary' : 'text-foreground'}`}
                >
                  {opt.label}
                </span>
              </OptionButton>
          ...
          <div className="grid grid-cols-3 gap-2">
            {THEME_OPTIONS.map((opt) => {
              ...
              return (
                ...
                >
                  <Icon
                    className={`w-4 h-4 ${theme === opt.value ? 'text-primary' : 'text-muted-foreground'}`}
                  />
                  <span
                    className={`text-xs font-medium ${theme === opt.value ? 'text-primary' : 'text-foreground'}`}
                  >
                    {opt.label}
                  </span>
                </OptionButton>
          ...
          <div className="grid grid-cols-2 gap-2">
            {FONT_OPTIONS.map((opt) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-medium ${fontStyle === opt.value ? 'text-primary' : 'text-foreground'}`}
                >
                  {opt.label}
                </span>
              </OptionButton>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <EmojiPicker
              value={aiAvatarEmoji ?? undefined}
              onChange={setAiAvatarEmoji}
            />
          </div>
          <div>
            <Label className="text-[11px] text-muted-foreground mb-1.5">
            ...
            <ColorPicker
              value={aiAvatarColor ?? undefined}
              onChange={setAiAvatarColor}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-[11px] text-muted-foreground mt-1">
            jpg/png/gif/webp，最大 3MB
          </p>
        </div>

        <Button
          onClick={handleSaveAiAppearance}
          disabled={aiAppearanceSaving}
          size="sm"
        >
      ...
      <Section icon={Lock} title="修改密码">
        ...
        <Button
          ...
          disabled={pwdChanging || !currentPwd || !newPwd}
          size="sm"
        >
